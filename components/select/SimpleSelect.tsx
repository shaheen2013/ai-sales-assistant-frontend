...
const SimpleSelect: FC<SimpleSelectPropsType> = ({ options, label, placeholder, onChange, value, defaultValue, triggerClassName, contentClassName, groupClassName, itemClassName, disabled, wrapperClassName }) => {
    return (
