...
function DashboardOverview() {
  return (
    <div className="py-2">
      {/* cards */}
      <div className="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-3 mb-3">
        {/* 1 */}
        <div className="bg-[#E5D9FF] shadow-md rounded-lg py-4 px-6 mb-4 w-full">
          {/* top */}
          <div className="flex justify-between items-center mb-4">
            {/* left */}
            <div>
              <h3 className="text-[#2A2F3D] text-lg font-medium">New Sell</h3>
            </div>
        ...
        {/* 2 */}
        <div className="bg-[#F0F4A9] shadow-md rounded-lg py-4 px-6 mb-4 w-full">
          {/* top */}
          <div className="flex justify-between items-center mb-4">
            {/* left */}
            <div>
              <h3 className="text-[#2A2F3D] text-lg font-medium">Payment</h3>
            </div>
          ...
          <div className="flex justify-between">
            <div>
              <h3 className="text-[#2A2F3D] font-semibold text-3xl">$6000</h3>
            </div>
        ...
        {/* 3 */}
        <div className="bg-[#DDF2F6] shadow-md rounded-lg py-4 px-6 mb-4 w-full">
          {/* top */}
          <div className="flex justify-between items-center mb-4">
            {/* left */}
            <div>
