...
export default function DashboardDealerInventory() {
  ...
  const [debouncedFSearchValue, setSearchF] = useDebounceValue("", 500);
    ...
    <>
      ...
      <div className="w-full">
        <div className="rounded-md border p-3">
          {/* header */}
          <div className="flex justify-between lg:flex-row flex-col-reverse items-center mb-4">
            {/* section selectors */}
            ...
            <div className="w-full lg:w-auto">
              {selectedPanel == "list" ? (
                <Input
                  ...
                  placeholder="Search"
                  className="lg:max-w-[350px] lg:w-[350px] lg:mb-0 mb-3 w-full h-10"
                  preIcon={
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="21"
          ...
          <DialogHeader>
            <DialogTitle>
              <svg
                ...
                className="-mt-2"
              >
                <g clipPath="url(#clip0_2638_17565)">
                  <path
