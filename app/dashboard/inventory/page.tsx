...
import { Select, SelectTrigger } from "@/components/shadcn/select";
  ...
  return (
    <div className="">
      ...
      <Dialog
        ...
        onOpenChange={(e) => {
          console.log(e);
          setModals((prev) => ({ ...prev, addInventory: !prev.addInventory }));
        }}
      >
        ...
        <DialogContent className="sm:max-w-[700px]">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="">
              <div className="grid grid-cols-2 gap-x-4 mb-6 max-h-[500px] overflow-y-auto">
                {/* stock id */}
                <div>
                  <label
                    htmlFor="stockId"
              ...
              <div className="flex justify-end gap-3">
                <Button
                  ...
                  onClick={() => setModals({ ...modals, addInventory: false })}
                >
                  Cancel
                </Button>
