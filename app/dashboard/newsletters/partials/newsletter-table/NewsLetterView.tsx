...
const NewsLetterView: FC<NewsLetterViewProps> = ({ data, open, onOpenChange }) => {
    return (
            ...
            <DialogContent className='max-w-xl'>
                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <p className='text-sm text-gray-600 font-normal'>{moment.utc(data?.created_at).format("MMM DD, YYYY | hh:mm A")}</p>
                    </div>
                </div>
            </DialogContent>
        </Dialog>
