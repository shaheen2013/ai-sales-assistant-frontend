      ...
      <div className="grid xl:grid-cols-4 lg:grid-cols-2 grid-cols-1 gap-3 mb-3">
        {Array.from({ length: 4 }).map((_, index) => {
          return (
            <div
              key={index}
              className="bg-[#E5D9FF] shadow-md rounded-lg py-4 px-6 mb-4 w-full"
            >
              {/* top */}
              ...
              <div className="flex justify-between">
                <div>
                  <h3 className="text-[#2A2F3D] font-semibold text-3xl">120</h3>
                </div>
...
export default useAuth(DashboardOverview, {
  key: "user",
});
