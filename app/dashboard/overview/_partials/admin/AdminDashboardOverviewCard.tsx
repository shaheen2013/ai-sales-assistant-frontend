...
const AdminDashboardOverviewCard:FC<AdminDashboardOverviewCardProps> = ({ bgColor, growth, lastMonthTotal, title }) => {
    return (
        <div
        ...
        >
            ...
            <div className="flex justify-between items-center mb-4">
                {/* left */}
                <div>
                    <h3 className="text-[#2A2F3D] text-lg font-medium">
                        {title}
                    </h3>
                </div>
            ...
            <div className="flex justify-between">
                <div>
                    <h3 className="text-[#2A2F3D] font-semibold text-3xl">{lastMonthTotal}</h3>
                </div>
