            ...
            <div className="grid xl:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-3 mb-4">
              ...
              <div className="p-4 rounded-xl bg-[#E5DCFA] flex justify-between">
                <div>
                  ...
                  <h3 className="text-gray-500 text-2xl font-semibold">{dealerDashboardOverviewData?.subscription?.remain_days} Days</h3>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h2 className="text-lg font-semibold">{formateDate(dealerDashboardOverviewData?.subscription?.end_date, "Do MMM, YYYY")}</h2>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#DDF2F6] flex justify-between">
                <div>
                  ...
                  <h3 className="text-gray-500 text-2xl font-semibold">{dealerDashboardOverviewData?.talk_time?.remaining} m</h3>
                </div>
