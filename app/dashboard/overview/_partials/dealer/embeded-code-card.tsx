...
const PublicEmbedCodeCard = () => {
  ...
  const embeddedCode = `<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="1440" height="800" src="${process.env.NEXT_PUBLIC_FRONTEND_URL}/dealers/${data?.data?.dealer_details?.id}" allowfullscreen></iframe>`
