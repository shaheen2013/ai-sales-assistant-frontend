...
interface TradeInDataTableProps {
  columns: ColumnDef<TradeInResponseType, unknown>[];
  data: TradeInResponseType[];
  loading: boolean;
}

const TradeInDataTable = ({
  columns,
  data,
  loading,
}: TradeInDataTableProps) => {
...
export default TradeInDataTable;
