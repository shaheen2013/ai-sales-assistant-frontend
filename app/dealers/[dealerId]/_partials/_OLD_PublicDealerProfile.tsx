...
import ShortBioSection from "@/app/dashboard/profile/short-bio-section";
// import ServicesOfferedSection from '@/app/dashboard/profile/services-offered-section'
import ContactInformationCard from "@/app/dashboard/profile/contact-information-card";
...
const PublicDealerProfile = () => {
  ...
  /*--RTK Query--*/
  const { data: dealerProfile, isLoading } = useGetDealerPublicProfileQuery(
    Number(dealerId)
  );
