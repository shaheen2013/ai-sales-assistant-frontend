...
export default function AnonymousChat() {
  ...
  const [messages, setMessages] = useState([
    { id: "5151", isMe: false, message: "Hello! How can I help you?" },
    { id: "5152", isMe: true, message: "I need help with my order." },
    {
      id: "5153",
      isMe: false,
      message: "Sure! Can you provide your order ID?",
    },
    { id: "5154", isMe: true, message: "It's 123456." },
    {
      id: "5155",
      isMe: false,
      message: "Thank you! Let me check that for you.",
    },
    { id: "5156", isMe: true, message: "I appreciate it!" },
    {
      id: "5157",
      isMe: false,
      message: "You're welcome! Is there anything else I can assist you with?",
    },
    { id: "5158", isMe: true, message: "No, that's all for now." },
    { id: "5159", isMe: false, message: "Alright! Have a great day!" },
    { id: "5160", isMe: true, message: "You too!" },
    { id: "5161", isMe: false, message: "Thank you!" },
    { id: "5162", isMe: true, message: "You're welcome!" },
    { id: "5163", isMe: false, message: "Goodbye!" },
    { id: "5164", isMe: true, message: "Goodbye!" },
    { id: "5165", isMe: false, message: "Take care!" },
    { id: "5166", isMe: true, message: "You too!" },
    { id: "5167", isMe: false, message: "See you later!" },
    { id: "5168", isMe: true, message: "See you later!" },
  ]);
    ...
    <div className="h-full py-6">
      <div className="flex flex-col h-full max-w-[930px] mx-auto border p-4 rounded-lg bg-white">
        ...
        <div className="flex flex-col flex-1">
          ...
          {/* message list */}
          <main className="overflow-y-auto h-[calc(100vh-380px)] my-6 message-scrollbar">
                  ...
                  <div key={index} className="mb-6 mr-3 flex justify-end">
                    <div className="max-w-[80%]">
                      ...
                      <div className="text-xs text-end mb-1 text-gray-800">
                        <span className="font-semibold">You</span>, 11:45 AM
                      </div>
