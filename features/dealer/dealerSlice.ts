...
import {
  CardInfo,
  Dealer,
  DealerCallStatsResponseType,
  DealerOverviewResponseType,
  DealerRegistrationSourceCount,
  DealerStatisticsResponseType,
  ProductResponseType,
} from "@/types/dealerType";
import {
  SupportStatusCountType,
  SupportTicketType,
} from "@/types/supportTicketType";
import { DealerPublicProfileType } from "@/types/dealerProfileSliceType";
...
export const dealerSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getDealerRegistrationCount: builder.query<
      DealerRegistrationSourceCount,
      Record<string, any>
    >({
      query: (queryParams) => ({
    ...
    getDealerAllSupportTickets: builder.query<
      PaginatedResponse<SupportTicketType> & SupportStatusCountType,
      Record<string, any>
    >({
      query: (queryParams) => ({
        method: "GET",
    ...
    updateDealerSupportTicket: builder.mutation<
      SupportTicketType,
      Record<string, any>
    >({
      query: ({ ticketId, data }) => ({
...
export const {
  useGetDealersQuery,
  useGetDealerStatisticsQuery,
  useGetDealerRegistrationCountQuery,
  useGetDealerAllSupportTicketsQuery,
  useCreateSupportTicketMutation,
  useUpdateDealerSupportTicketMutation,
  useDeleteDealerSupportTickerMutation,
  useGetDealerPublicProfileQuery,
